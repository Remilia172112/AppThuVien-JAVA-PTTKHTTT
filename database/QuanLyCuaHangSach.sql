...
VALUES
        ...
        ('Phạm Thị Mai', '234 Lê Hồng Phong, Quận 5, TP. Hồ Chí Minh', '0946789013', 1, '2023-04-30 18:18:34'),
        ('Hoàng Văn Nam', ' 567 Phố Huế, Quận Hai Bà Trưng, Hà Nội', '0912345679', 1, '2023-04-30 18:19:16');
...
VALUES
        ...
        ('Tư duy ngược', '050d67e2d58f5e291cbf25da53f55ef7.jpg', 'Sách dành cho giới trẻ', 2020, 10,'Nguyễn Anh Dũng', 1, 125000, 100000, 1, 9786043440287, 1),
        ('Bạn đắt giá bao nhiêu?', 'txq47334nnwj1cw5f5ux7egme8erj2k7.jpg', 'Sách dành cho giới trẻ', 2021,9 ,'Vãn Tình', 1, 107000, 100000, 1, 8936186543500, 1),
        ('Hãy gọi tên tôi', '90adcd1cc9b81aa80a272a653c7785e5.png', 'Sách dành cho giới trẻ', 2020,11 ,'Chanel Miller', 1, 118000, 100000, 1, 9786046863747, 1),
        ('Đời ngắn đừng ngủ dài', 'q9rcr9y1ax8gb1u372kxb0eivlg2xegc.jpeg', 'Sách dành cho giới trẻ', 2020,2 ,'Robin Sharma', 1, 64000, 60000, 1, 8934974158691, 1),
        ('Tội ác sau những bức tranh', 'rl7k9yn47k492vlxrbbnx9jmdy3ps89x.jpeg', 'Văn học - Nghệ thuật', 2022,6 ,'Jason Rekulak', 2, 146000, 100000, 1, 8934974158692, 1),
        ...
        ('Tạp văn Nguyễn Ngọc Tư', '4b1ea768cbbef544c4ca16fe1967634b.jpg', 'Văn học - Nghệ thuật', 2021,2 ,'Nguyễn Ngọc Tư', 2, 72000, 60000, 1, 8934974168607, 1),
        ('Bông sen vàng', 'ythnuw9ks3kk4l0lb1pa6fdtoo1tz32a.jpeg', 'Văn học - Nghệ thuật', 2022,5 ,'Sơn Tùng', 2, 144000, 60000, 1, 8934974168617, 1),
        ('Hoa tuylip đen', 'sbgtbeq0vz1dhnag0qf3jrp6enxjgw20.jpeg', 'Văn học - Nghệ thuật', 2017,22 ,'Alexandre Dumas cha', 2, 49000, 30000, 1, 8936067597097, 1),
        ('Truyện ngụ ngôn E Dốp', '883868zq1vtv4qqm7plgby2g8k0i2mkv.jpeg', 'Văn học - Nghệ thuật', 2019,22 ,'Aesop', 2, 59000, 30000, 1, 9786049633198, 1),
        ('Nhật ký trong tù', 'cd19aa6163295ef2dff24012f78b9aec.jpg', 'Văn học - Nghệ thuật', 2021,5 ,'Hồ Chí Minh', 2, 105000, 50000, 1, 9786043238112, 1),
        ('Phận liễu', 'detep2imksxnh97om03avji0q1p47clp.jpeg', 'Văn học - Nghệ thuật', 2020,12 ,'Chu Thanh Hương', 2, 162000, 50000, 1, 9786047244300, 1),
        ('Đồng tiền hạnh phúc', '6619719473f6f132a18182f019364abf.jpg', 'Văn học - Nghệ thuật', 2020,13 ,'Ken Honda', 2, 85500, 50000, 1, 8935095629664, 1),
        ('Lũ trẻ thủy tinh', 'rnwjyi3x3zzxzjxlq4ba0zaeqpu0lugk.jpeg', 'Văn học thiếu nhi', 2021,1 ,'Kristina Ohlsson', 3, 28000, 10000, 1, 9786042190862, 1),
        ('Lũ trẻ đường ray', '22znw9gr4514dul0lc5rgisvc47qxfw6.jpeg', 'Văn học thiếu nhi', 2020,22 ,'Edith Nesbit', 3, 63000, 50000, 1, 9786049693465, 1),
        ('Tớ sợ cái đồng hồ', 'fs2xgxjq2yswm6l33gfv50mwg6mgu4qm.jpeg', 'Văn học thiếu nhi', 2018,14 ,'Nguyễn Quỳnh Mai', 3, 52000, 30000, 1, 9786045653012, 1),
        ('Khu rừng trong thành phố', 'cmpq0o6lb0jqmna7f9n2k7y61z84if0u.jpeg', 'Văn học thiếu nhi', 2018,14 ,'Nguyễn Quỳnh Mai', 3, 58000, 30000, 1, 9786045653005, 1),
        ('Đảo ngàn sao', '5hghrc3synmydygcyzwsl7noz3pt7u31.jpeg', 'Văn học thiếu nhi', 2021,1 ,'Emma Karinsdotter', 3, 48000, 30000, 1, 9786042221603, 1),
        ('Cậu bé bạc', 'ivssbyx4axf57c2tsww8kqyt1a4xauhv.jpeg', 'Văn học thiếu nhi', 2020,1 ,'Kristina Ohlsson', 3, 30000, 10000, 1, 9786042186315, 1),
        ('Ngựa ô yêu dấu', 'wf05ukmavgsdar1a772qc24c1iawtcfg.jpeg', 'Văn học thiếu nhi', 2022,23 ,'Anna Sewell', 3, 109000, 50000, 1, 9786043565027, 1),
        ('Chuyện con mèo dạy hải âu bay', 'iuj2x3gbldratw5xzjg9s1aterb66k8t.jpeg', 'Văn học thiếu nhi', 2019,4 ,'Luis Sepúlveda', 3, 42000, 10000, 1, 8935235222113, 1),
        ('Chú bé mang Pyjama sọc', 'o53krzx7g5du11thdcme6xl2uqd2s8gp.jpeg', 'Văn học thiếu nhi', 2018,4 ,'John Boyne', 3, 58000, 30000, 1, 8935235217898, 1),
        ('Những lá thư thời chiến Việt Nam (Tuyển tập)', '25ac83e2311e9fcaf146c655f672d6eb.jpg', 'Sách Chính trị - Xã hội', 2023,5 ,'Đặng Vương Hưng', 4, 144000, 100000, 1, 8935279148646, 1),
        ('Kỷ yếu Hoàng Sa', 'kry3vs4zab398dch1jc23zycidl0jvaq.jpeg', 'Sách Chính trị - Xã hội', 2014,15 ,'UBND Huyện Hoàng Sa', 4, 153000, 100000, 1, 9786048002930, 1),
        ('Dấu ấn Việt Nam trên Biển Đông', '1odzbcuzqspuou03uwdnstegf6pe4jp6.jpeg', 'Sách Chính trị - Xã hội', 2012,15 ,'TS. Trần Công Trục', 4, 191000, 100000, 1, 9786048018740, 1),
        ('Chân dung Ngô Tất Tố', 'ytja13yxd96huojklmyy1cadwq4rykoi.jpeg', 'Sách Chính trị - Xã hội', 2014,15 ,'Cao Đắc Điểm - Ngô Thị Thanh Lịch', 4, 38000, 20000, 1, 9786048005214, 1),
        ('Chính sách đối ngoại đổi mới của Việt Nam (1986 - 2015)', 'eplg2rc40dd1zfp0wzp4zo5s0aok0khp.jpeg', 'Sách Chính trị - Xã hội', 2018,16 ,'PGS. TS. Phạm Quang Minh', 4, 56000, 30000, 1, 9786047744749, 1),
        ('Đặc trưng và vai trò của tầng lớp trung lưu ở Việt Nam', 'v4e1gkm2jgz2b7tdktk504lsgemrff59.jpeg', 'Sách Chính trị - Xã hội', 2022,17 ,'TS. Lê Kim Sa', 4, 81000, 70000, 1, 9786043089585, 1),
        ('Sức mạnh mềm văn hóa Trung Quốc thời Tập Cận Bình và ứng xử của Việt Nam', 'qkphoffa38djvveox22613t5qx00ha8c.jpeg', 'Sách Chính trị - Xã hội', 2022,17 ,'Ths.Chử Thị Bích Thu - TS.Trần Thị Thủy (Đồng chủ biên)', 4, 99000, 50000, 1, 97860430839493, 1),
        ('Đường tới Điện Biên Phủ', 'dbd44e00c80b8c79694bc2a87a36c20f.jpg', 'Sách Chính trị - Xã hội', 2018,15 ,'Đại tướng Võ Nguyên Giáp', 4, 47000, 30000, 1, 9786048030759, 1),
        ('Đường tới Truông Bồn huyền thoại', 'wofawcrdyttsuu37j3mh06i2m6ii0lq0.jpeg', 'Sách Chính trị - Xã hội', 2019,18 ,'Văn Hiền', 4, 150000, 100000, 1, 9786049642937, 1),
        ('Vương Dương Minh toàn thư', '8b90cf59071f3ed109d17770a0ec50ed.jpg', 'Sách Chính trị - Xã hội', 2023,15 ,'Túc Dịch Minh - Nguyễn Thanh Hải', 4, 443000, 300000, 1, 9786048083021, 1),
        ('Thoát khỏi địa ngục Khmer đỏ - Hồi ký của một người còn sống', '7lmy4xhmjhgiqap0p6b2mt8ft12ju5pu.png', 'Sách Chính trị - Xã hội', 2019,5 ,'Denise Affonco', 4, 74000, 50000, 1, 9786045751718, 1),
        ('Điện Biên Phủ - Điểm hẹn lịch sử', '240bb8a0096e82c9769587fdb0ccfe2a.jpg', 'Sách Chính trị - Xã hội', 2018,15 ,'Đại tướng Võ Nguyên Giáp', 4, 53000, 30000, 1, 9786048030742, 1),
        ('Sử liệu cổ nhạc Việt Nam', 'kzaj4gc27vz9pguxepwe3uoz630caym2.jpeg', 'Sách Chính trị - Xã hội', 2020,19 ,'Đặng Hoành Loan', 4, 405000, 30000, 1, 9786047029396, 1),
        ('Sự sinh thành Việt Nam', '7p1zz1z2gdgxk3f7p62nrd0xdn24sn0x.jpeg', 'Sách Chính trị - Xã hội', 2018,16 ,'GS. Hà Văn Tấn', 4, 96000, 30000, 1, 9786047730087, 1),
        ('Người Dao Tiền ở Việt Nam', 'lc205cd61ud39xfvfom6lqxbeu8rklw5.jpeg', 'Sách Chính trị - Xã hội', 2021,17 ,'Lý Hành Sơn', 4, 157000, 100000, 1, 9786043086072, 1),
        ('Tôn tử binh pháp', 'wufet92dnkp0jt7yzehtazcyvrpnhll3.jpeg', 'Sách Chính trị - Xã hội', 2019,20 ,'Tôn Tử', 4, 64000, 30000, 1, 8935235222564, 1),
        ('5 đường mòn Hồ Chí Minh', '48a0hx2ovces506vnslpveb0qjcy6gi9.jpeg', 'Sách Chính trị - Xã hội', 2020,15 ,'Đặng Phong', 4, 161000, 100000, 1, 9786048049669, 1),
        ('Việt Nam bản hùng ca giữ nước', '363454f37c5e79344b2a87e4d0155e7e.png', 'Sách Chính trị - Xã hội', 2021,15 ,'Đặng Văn Việt', 4, 256000, 100000, 1, 9786048052508, 1),
        ('Bất khuất Mường Lò', 'w1xynsdkve2rv9k58gdkn8eixbvulr5y.jpeg', 'Sách Chính trị - Xã hội', 2023,19 ,'Trần Cao Đàm', 4, 108000, 50000, 1, 9786047035649, 1),
        ('Nếm trải Điện Biên', 'hgnpj4w7mbutt0tg9pjbsa8eu15q9k3a.jpeg', 'Sách Chính trị - Xã hội', 2018,15 ,'Cao Tiến Lê', 4, 33000, 10000, 1, 9786048032661, 1),
        ('Đường Bác Hồ Đi Cứu Nước', 'oqzeqlleza3c8550w5jjg54kvloow7oy.jpeg', 'Sách Chính trị - Xã hội', 2021,5 ,'GS.TS. Trình Quang Phú', 4, 148000, 100000, 1, 9786045767559, 1),
        ('Ký ức chiến trận - Quảng Trị 1972 - 2022 (Bìa cứng) - Nguyễn Xuân Vượng', 'ds7l546w53f0otq26c67em4mle8xoszq.jpeg', 'Sách Chính trị - Xã hội', 2022, 10,'Nguyễn Xuân Vượng', 4, 160000, 100000, 1, 9786043566628, 1);
